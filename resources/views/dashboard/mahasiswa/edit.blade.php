...
@section('content')
    ...
    <div class="row">
        ...
        @enderror"
                        name="nama_lengkap" id="nama_lengkap" value="{{ old('nama_lengkap', $mahasiswas->nama_lengkap) }}">
                    @error('nama_lengkap')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
        ...
        @enderror"
                        name="tempat_lahir" id="tempat_lahir" value="{{ old('tempat_lahir', $mahasiswas->tempat_lahir) }}">
                    @error('nama_lengkap')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
        ...
        @enderror"
                        name="tanggal_lahir" id="tanggal_lahir" value="{{ old('tanggal_lahir', $mahasiswas->tanggal_lahir) }}">
                    @error('tanggal_lahir')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
        ...
        @enderror" name="email"
                        id="email" value="{{ old('email', $mahasiswas->email) }}">
                    @error('email')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="prodi_id" class="form-select">
                        ...
                        @if (old('prodi_id',$mahasiswas->prodi_id) == $dataprodi->id)
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat">{{ old('alamat', $mahasiswas->alamat) }}
            @error('alamat')
<div class="invalid-feedback">
            {{ $message }}
        </div>
